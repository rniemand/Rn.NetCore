...
[TestFixture]
public class MySqlConnectionHelperTests
{
  ...
  public void GetConnection_GivenNoConnectionStringFound_ShouldThrow()
  {
    ...
    // act
    var connectionHelper = GetMySqlConnectionHelper(
  ...
  public void GetConnection_GivenConnectionStringFound_ShouldCreateSqlConnection()
  {
    ...
    // assert
    connectionResolver.Received(1).MyCreateSqlConnection(ResolvedConnString);
  }
  ...
  public void GetConnection_GivenConnectionClosed_ShouldOpenConnection()
  {
    ...
    connectionResolver
      .MyCreateSqlConnection(ResolvedConnString)
      .Returns(dbConnection);
  ...
  // Internal methods
  private static MySqlConnectionHelper GetMySqlConnectionHelper(
    ILoggerAdapter<MySqlConnectionHelper>? logger = null,
    IConnectionResolver? connectionResolver = null,
    ISqlFormatter? sqlFormatter = null) =>
    new(logger ?? Substitute.For<ILoggerAdapter<MySqlConnectionHelper>>(),
